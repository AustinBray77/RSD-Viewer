...
export default function Toolbar(props: {
    ...
    const { data, password, error } = props.AppState;
    ...
    if (state.phoneNumber.Value != phoneNumber && phoneNumber != "") {
        state.phoneNumber.Set(phoneNumber);
    }

    let animationClass = retracted.Value
        ? "toolbar-retracted"
        : "toolbar-normal";
    ...
    return (
        <div id="Toolbar">
            ...
            <AddAccountDialog ToolbarState={state} AppState={props.AppState} />
            ...
            <AddPhoneNumberDialog
                ...
                AppState={props.AppState}
            />
            <Verify2FADialog ToolbarState={state} AppState={props.AppState} />
            <ImportFileDialog
                ToolbarState={state}
